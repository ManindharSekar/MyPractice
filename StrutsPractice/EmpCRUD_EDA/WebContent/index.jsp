...
<html:submit property="empsave"><bean:message key="save"/></html:submit>
<html:submit property="empupdate"><bean:message key="update"/></html:submit>
<html:submit property="empdelete"><bean:message key="delete"/></html:submit>
<html:submit property="empfind"><bean:message key="find"/></html:submit>
